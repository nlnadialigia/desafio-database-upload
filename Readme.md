...
Continuação do desenvolvimento da aplicação de gestão de transações, com a inclusão do uso de banco de dados com o TypeORM e envio de arquivos com o Multer!
...
<h4 align="center">
  ⚠️ Antes de rodar os testes, criar um banco de dados com o nome "gostack_desafio06_tests" para que todos os testes possam executar corretamente ⚠️
</h4>
...
[Importando arquivos CSV com Node.js](https://www.notion.so/Importando-arquivos-CSV-com-Node-js-2172338480cb47e28a5d3ed9981c38a0).
